...
python scripts/run_open_tabular_benchmark.py --classification-datasets   --regression-datasets california_housing concrete_compressive_strength superconductivity diamonds --n-jobs 12 --outdir outputs/open_tabular_benchmark_regression_loss_report --use-report-metric-for-selection --max-rounds 300 --selection-checkpoints 100 200 300 --ctb-inner-bootstraps 4 --ctb-etas 1.0 --ctb-target-modes loss_aware --ctb-weak-learner-backends sklearn_tree --families ctb
