...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--colsample-bytree", nargs="*", type=float, default=None)
    parser.add_argument("--ctb-inner-bootstraps", nargs="*", type=int, default=None)
    parser.add_argument("--ctb-etas", nargs="*", type=float, default=None)
