...
def ctb_tree_model_name(
    *,
    ...
    base = f"ctb_depth{depth_i}__curv-{_format_curvature_eps(float(transport_curvature_eps))}__ridge-{_format_curvature_eps(float(leaf_ridge))}"
...
def canonical_ctb_tree_result_method(
    ...
    *,
    ...
    return (
        ...
        f"__ridge-{_format_curvature_eps(float(leaf_ridge))}"
    )
